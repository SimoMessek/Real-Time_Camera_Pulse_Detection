...
class getPulseApp(object):
    # TODO: fix ipcam "SIMO" guys am not sure about this one i'll work on it later it sounds cool having an IP cam access
    def __init__(self, args):
        ...
        # face detection, forehead isolation, time series collection,
        # heart-beat detection, etc.

        self.processor = findFaceGetPulse(bpm_limits=[50, 160],
                                          data_spike_limit=2500.,
                                          face_detector_smoothness=20.)

        # Init parameters for the cardiac data plot
        self.bpm_plot = False
        self.plot_title = "Data display - raw signal (top) and PSD (bottom)"

        #Keybinding well we can change them later if we want
